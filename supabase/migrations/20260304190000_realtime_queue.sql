-- Enable Realtime for live queue (Step 9)
-- Run in: Supabase Dashboard → SQL Editor → Run

-- Needed so filters on doctor_id work for UPDATE events
...
-- Include doctor_id in staff queue payload (for Realtime channel filter)
